                ...
                <form action="{{ route('bills.store', []) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="bill_no" name="bill_no" value="{{ uniqid() }}"  required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6">
                    ...
                    <table class="table table-striped table-bordered " id="itemTable">
                        ...
                        <tbody>
                            <tr id="row_1">
                                <td scope="row">1</td>
                                <td>
                                    <select name="item_id[]" id="item_id_1" class="form-control"
                                        onchange="GetItemPrice(this.value,1)" required>
                                        <option value="">Select</option>
                                ...
                                <td><input type="text" name="rate[]" id="rate_1" class="form-control" readonly required></td>
                                <td><input type="text" name="qty[]" id="qty_1" value="1" class="form-control"
                                        onkeyup="CalculateProductAmount(this.value,1)" required></td>
                                <td><input type="text" name="amount[]" id="amount_1" value="0" class="form-control" required></td>
                                <td>
                    ...
                    <div class="form-group row">
                        <div class="offset-md-6 col-sm-6">
                            ...
                            <input type="number" id="totalamount" class="form-control" name="totalamount" required>
                        </div>
                    </div>
